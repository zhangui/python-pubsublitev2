...
"""
Test AdminServiceClient using Managed Kafka transport (Google Cloud API).

This uses managedkafka_v1 with Application Default Credentials instead of
confluent_kafka AdminClient. This is the recommended approach for MSAK.
"""
...
def test_admin_managedkafka(
    project_id: str,
    location: str,
    cluster_id: str,
):
    """Test AdminServiceClient with Managed Kafka transport.
    ...
    """
    print("\n=== Testing AdminServiceClient with Managed Kafka Transport ===\n")

    print("1. Creating AdminServiceClient")
    print(f"   Project: {project_id}")
    print(f"   Location: {location}")
    print(f"   Cluster: {cluster_id}")
    print("   Using Application Default Credentials\n")

    # Create admin config with cluster ID
    admin_config = {
        'cluster_id': cluster_id,
    }

    try:
        # Create AdminServiceClient with managedkafka transport
    ...
    test_topic_name = "test-managedkafka-topic"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Test AdminServiceClient with Managed Kafka transport"
    )
    parser.add_argument(
        "--project-id",
