...
class SubscriberServiceClient(metaclass=SubscriberServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = SubscriberServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = SubscriberServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SubscriberServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SubscriberServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,SubscriberServiceTransport,Callable[..., SubscriberServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SubscriberServiceTransport constructor.
        ...
        ) = SubscriberServiceClient._read_environment_variables()
        self._client_cert_source = SubscriberServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SubscriberServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, SubscriberServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(SubscriberServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SubscriberServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.pubsublite_v1.SubscriberServiceClient`.",
                    extra={
