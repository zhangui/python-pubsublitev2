...
try:
    from .transports.kafka import AdminServiceKafkaTransport
    HAS_KAFKA = True
except ImportError:
    HAS_KAFKA = False
...
class AdminServiceClient(metaclass=AdminServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdminServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdminServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            admin_config (Optional[Dict]): Kafka admin configuration dict.
        ...
        self._client_cert_source = AdminServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AdminServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdminServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdminServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AdminServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            # Add admin_config if provided (only used by Kafka transport)
            if admin_config is not None:
                transport_kwargs["admin_config"] = admin_config
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.pubsublite_v1.AdminServiceClient`.",
                    extra={
