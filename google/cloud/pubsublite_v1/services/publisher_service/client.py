...
class PublisherServiceClient(metaclass=PublisherServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PublisherServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PublisherServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = PublisherServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = PublisherServiceClient._read_environment_variables()
        self._client_cert_source = PublisherServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PublisherServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, PublisherServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(PublisherServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or PublisherServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.pubsublite_v1.PublisherServiceClient`.",
                    extra={
